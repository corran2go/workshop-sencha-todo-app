...
Ext.data.WebSqlProxy = Ext.extend(Ext.data.Proxy, {
    ...
    constructor: function(config) {
      ...
      Ext.data.WebSqlProxy.superclass.constructor.call(this, config);
	...
	checkDependencies: function(){
		...
		if (!Ext.isString(me.dbName))  console.log("The dbName string has not been defined in your Ext.data.proxy.WebDB");
		if (!Ext.isString(me.dbTable)) console.log("The dbTable string has not been defined in your Ext.data.proxy.WebDB");
